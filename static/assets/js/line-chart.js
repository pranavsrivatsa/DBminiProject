...
/* MONTH GRAPHS */
function renderMonthGraph(dates,dayRevenue,dayCount,Days){
  var chartData = [];
  for (i=0;i<Days;i++) {
    chartData.push({
        date: new Date(dates[i]),
  ...
  var chart = AmCharts.makeChart("month_stats", {
      "type": "serial",
      "theme": "light",
      "marginRight": 20,
      "autoMarginOffset": 20,
...
/* --------------------------- */
function renderRideMonthRevenueGraph(dates,cr,drr,dtr,fwr,gtr,rcr,wrr,ssr,cir,gr,hours){
  var chartData = [];
  for (i=0;i<hours;i++) {
    chartData.push({
        date: new Date(dates[i]),
  ...
  var chart = AmCharts.makeChart("ride_month_stats", {
      "type": "serial",
      "theme": "light",
      "marginRight": 20,
      "autoMarginOffset": 20,
...
/* ---------------------------------- */
function renderRideMonthCountGraph(dates,cc,drc,dtc,fwc,gtc,rcc,wrc,ssc,cic,gc,hours){
  var chartData = [];
  for (i=0;i<hours;i++) {
    chartData.push({
        date: new Date(dates[i]),
  ...
  var chart = AmCharts.makeChart("ride_month_count", {
      "type": "serial",
      "theme": "light",
      "marginRight": 20,
      "autoMarginOffset": 20,
